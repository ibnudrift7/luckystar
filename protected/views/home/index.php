			...
			<?php foreach($products->getData() as $key => $value): ?>
				<div class="col-md-10 col-30">
					<div class="box-content">
						<div class="image"><a href="<?php echo CHtml::normalizeUrl(array('/product/detail', 'id'=> $value->id, 'slug'=>Slug::Create($value->description->name) )); ?>"><img class="w-100 img img-fluid" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(236,236, '/images/product/'. $value->image , array('method' => 'adaptiveResize', 'quality' => '90')); ?>" alt=""></a></div>
						<div class="judul">
							<p><a href="<?php echo CHtml::normalizeUrl(array('/product/detail', 'id'=> $value->id, 'slug'=>Slug::Create($value->description->name) )); ?>"><?php echo $value->description->name; ?></a></p>
						</div>
						<div class="lihat"><a href="<?php echo CHtml::normalizeUrl(array('/product/detail', 'id'=> $value->id, 'slug'=>Slug::Create($value->description->name) )); ?>">lihat produk</a></div>
					</div>
				</div>
			<?php endforeach ?>
		</div>
